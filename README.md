...
|---|---|---|
| **Nova** | Self-hosted personal voice AI assistant, bilingual EN/ML, modular architecture | Local LLMs, Python |
| **Pramana** | Criminal case analysis tool with fact/assumption separation | Self-hosted AI stack |
| **Dayflow** | HRMS built in a hackathon — owned Leave & Payroll/Analytics modules | Next.js 14, Supabase, Prisma |
